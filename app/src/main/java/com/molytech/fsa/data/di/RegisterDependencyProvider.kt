...
import com.molytech.fsa.ui.register.RegisterViewModelFactory

object RegisterDependencyProvider {
    ...
    fun provideRegisterViewModelFactory(context: Context): RegisterViewModelFactory {
        ...
        val validateRegistrationFieldsUseCase = ValidateRegistrationFieldsUseCase()
